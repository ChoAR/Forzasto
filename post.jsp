...
<table width="600" cellpadding="3" align="center">
	<tr>
		...
		<table align="center">
			<tr>
				<td width="10%"><br>성 명</td>
				<td width="90%"><br>
				<input name="name" size="67" maxlength="50"></td>
			</tr>
			<tr>
				<td><br>제 목</td>
				<td><br>
				<input name="subject" size="67" maxlength="50"><br></td>
			</tr>
			<tr>
				<td><br>내 용</td>
				<td><br>
				<textarea name="content" rows="50" cols="70"></textarea><br></td>
			</tr>
			<tr>
				<td><br>비밀번호</td>
				<td><br>
				<input type="password" name="pass" size="67" maxlength="15"><br></td>
			</tr>
			<tr>
			 <tr>
     			<td>파일찾기</td> 
     			<td><br><input type="file" name="filename" size="52" maxlength="30">
     			<br>여러사진을 압축하여 알집으로 올려주세요.</td>
     			<br><br>
     			</tr>
