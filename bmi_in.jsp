...
<div id="container">
		...
		<div class="contents column">
			...
			<div class="tbl-y-wrap r5">
				<form name="frm" method="post">
					<table class="tbl-y">
						...
						<tbody>
							<tr>
								<label><th>성별 </th></label>
								<td>
									<input type="radio"  name="sex" value="여" checked><label class="pre" for="female">여자</label>
									<input type="radio"  name="sex" value="남" ><label class="pre" for="male"> 남자</label>
								</td>
							</tr>
							<tr>
								<label><th> 연령</th></label>
								<td>
									<div class="date-wrap clfix">
										<input type="text" class="ipt2" style="width:95px" id="byear" name="byear" onkeydown="this.value=this.value.replace(/[^0-9]/g,'')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" onblur="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="4" /><span class="dash"> 년  </span>
			...
			<div class="btn-ac">
					<input type="image"  src="assets/img/btn_ok.gif" name="submit" value="확인" onclick="valid(this.form); return false;">
				</div>
			</div>
			</div>
